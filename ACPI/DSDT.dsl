 ...
 *
 * Disassembly of DSDT.aml, Mon May 16 22:47:10 2016
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00019593 (103827)
 *     Revision         0x02
 *     Checksum         0x15
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    External (_SB_.PCI0.IGPU.CDDS, MethodObj)    // 1 Arguments
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x67FAD000, 0x0633)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0x67F2CF18, 0x10)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (GPI0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.GPI0._CRS._Y21._INT, IRQN)  // _INT: Interrupts
    ...
    Scope (_SB)
    {
        ...
        Device (WMI)
        {
            ...
            Method (SCMD, 3, Serialized)
            {
                ...
                If (LEqual (ToInteger (Arg1), 0x79))
                {
                    ...
                    While (One)
                    {
                        ...
                        {
                            Store (ToInteger (ARGS), ^^PCI0.LPCB.EC.XFAN)
                        }
            ...
            Method (WMBB, 3, Serialized)
            {
                ...
                {
                    Store (Arg1, _T_0)
                    If (LNotEqual (Match (Package (0x20)
                                    {
                                        One, 
                                        0x05, 
                                        0x06, 
        ...
        Device (EC)
        {
            ...
            Method (_Q11, 0, NotSerialized)  // _Qxx: EC Query
            {
                ...
                If (And (WINF, One))
                {
                    ...
                    ElseIf (LEqual (^^^IGPU.CDDS (0x0410), 0x1F))
                    {
                        Notify (^^^IGPU.DD1F, 0x87)
                    }
                }
