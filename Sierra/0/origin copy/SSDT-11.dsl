 ...
 *
 * Disassembly of SSDT-11.aml, Fri Sep 30 22:36:25 2016
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000233B (9019)
 *     Revision         0x01
 *     Checksum         0x4B
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.GFX0)
    {
        ...
        Method (HDSM, 4, Serialized)
        {
            ...
            {
                Return (\_SB.PCI0.PEG0.PEGP.SPB (Arg0, Arg1, Arg2, Arg3))
            }
    ...
    Scope (\_SB.PCI0)
    {
        Name (VEN, "VENACPI 2009-Nov-23 14:56:05")
    }
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (THCH, 2, Serialized)
        {
            ...
            While (One)
            {
                ...
                ElseIf (LEqual (_T_0, One))
                {
                    ...
                    Notify (\_SB.PCI0.PEG0.PEGP, 0xC1)
                }
        ...
        Method (SPB2, 2, NotSerialized)
        {
            ...
            CreateDWordField (Local0, Zero, LLLL)
            Store (Arg1, LLLL)
            Return (SPB (Zero, 0x0101, Arg0, Local0))
        }
        ...
        Method (SPB, 4, Serialized)
        {
            ...
            While (One)
            {
                ...
                If (LEqual (_T_0, Zero))
                {
                    ...
                    ShiftLeft (One, Local2, Local2)
                    Or (DerefOf (Index (Local0, Local1)), Local2, Index (Local0, Local1))
                    Divide (0x24, 0x08, Local2, Local1)
                    ShiftLeft (One, Local2, Local2)
                    Or (DerefOf (Index (Local0, Local1)), Local2, Index (Local0, Local1))
        ...
        Name (SCPP, Buffer (0x48) {})
        CreateDWordField (SCPP, Zero, VRV0)
